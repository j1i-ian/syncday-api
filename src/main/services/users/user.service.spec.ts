...
describe('Test User Service', () => {
    ...
    let oauth2TokenServiceConverterStub: sinon.SinonStubbedInstance<CoreGoogleConverterService>;
    ...
    before(async () => {
        ...
        oauth2TokenServiceConverterStub = sinon.createStubInstance(CoreGoogleConverterService);
