...
import { OAuth2MetaInfo } from '@interfaces/users/oauth2-metainfo.interface';
import { OAuth2UserProfile } from '@interfaces/users/oauth2-user-profile.interface';
...
import { VerificationService } from '../../auth/verifications/verification.service';
import { Language } from '../../enums/language.enum';
import { AlreadySignedUpEmailException } from '../../exceptions/already-signed-up-email.exception';
import { EmailVertificationFailException } from '@exceptions/users/email-verification-fail.exception';
import { PhoneVertificationFailException } from '@exceptions/users/phone-verification-fail.exception';
import { AlreadySignedUpPhoneException } from '@exceptions/already-signed-up-phone.exception';
