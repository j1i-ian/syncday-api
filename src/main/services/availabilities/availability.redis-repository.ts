...
import { CannotFindAvailabilityBody } from '@exceptions/availabilities/cannot-find-availability-body.exception';
import { AvailabilityBodySaveFail } from '@exceptions/availabilities/availability-body-save-fail.exception';
...
export class AvailabilityRedisRepository {
    ...
    clone(
        ...
        return from(this.getAvailabilityBody(teamUUID, profileId, sourceAvailabilityUUID)).pipe(
